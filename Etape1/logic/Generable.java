    ...
    public void check_is_valid(  List<? extends Wood> listWood , int id ,Object obj ){
            //List <String> list_invalid = new ArrayList <>() ; 
              ...
              for(int i = 0 ; i< listWood.size() ; i++ ){
                    ...
                    System.out.println(  wood_type +   ConsoleColors.BLUE_BOLD  + " with id " + listWood.get(i).id +  ConsoleColors.RESET  +" has an invalid table "+ v.invalidate_result(listWood.get(i).id ,listWood.get(i).prix ,listWood.get(i).nombre,listWood.get(i).date,listWood.get(i).dim)) ;
            }
            //return list_invalid ; 
    }
